\title{Articles of Association of Oxford Hackspace Ltd}
\begin{enumerate}
...
\item
  ...
  \item
    to provide an accessible community workshop in Oxford, UK, philosophically open to all and supporting initiative, learning, creativity and the social good,
  \item
    to promote and encourage technical, scientific, and artistic skills through social collaboration and education,
  \item
    to provide social and other facilities for Members as may from time to time be determined by the directors, and
  \item
    to acquire and take over all or any part of the assets and liabilities and business of the present unincorporated body known as ``Oxford Hackspace''.
  \end{enumerate}
